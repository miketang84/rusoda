...
pub fn zone8(value: TeraValue, _args: HashMap<String, TeraValue>) -> TeraResult<TeraValue> {
...
pub fn i18n(value: TeraValue, _args: HashMap<String, TeraValue>) -> TeraResult<TeraValue> {
